    ...
    def register_screen(cls, order):
        ...
        def decorator(screen_cls):
            ...
            def new_init(self, *args, **kwargs):
                ...
                home_btn.align(lv.ALIGN.BOTTOM_LEFT, 40, -5)
...
class Screen3(lv.obj):
    def __init__(self, app, *args, **kwds):
        ...
        prevBtn.add_event_cb(lambda e: callback('Prev', valueLbl), lv.EVENT.CLICKED, None)
        ...
        nextBtn.add_event_cb(lambda e: callback('Next', valueLbl), lv.EVENT.CLICKED, None)
        ...
        RgbBtn.add_event_cb(lambda e: rgb_callback('red', LEDvalueLbl), lv.EVENT.CLICKED, None)
        ...
        rGbBtn.add_event_cb(lambda e: rgb_callback('green', LEDvalueLbl), lv.EVENT.CLICKED, None)
        ...
        rgBBtn.add_event_cb(lambda e: rgb_callback('blue', LEDvalueLbl), lv.EVENT.CLICKED, None)
...
class ScreenLightIntensity(lv.obj):
    def __init__(self, app, *args, **kwds):
        ...
        self.chart.set_range(lv.chart.AXIS.PRIMARY_Y, 0, 1000)  # Y-axis range: ADC resolution (12-bit)
...
def rgb_callback(s, LEDvalueLbl):
    global rgb_val
    rgb_val = s
    LEDvalueLbl.set_text('RGB Color: ' + str(rgb_val))
    if s == 'red':
